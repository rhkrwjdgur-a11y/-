...
[미비 항목 및 보완 요청 사유]
{missing_items_text}
[보완 조치 방법 (아래 2가지 중 택 1)]
1. 서류 제출 가능 시: 본 메일(rhkrwjdgur@yonseidairy.com)로 누락된 증빙 서류를 첨부하여 직접 회신
2. 서류 제출 불가 시: 해당 서류가 귀사의 거래 형태상 불필요한 경우, 본 메일 회신으로 명확한 '해당사항 없음 사유'를 작성하여 회신 (예: 설립 3년 미만으로 재무제표 발급 불가 등)
